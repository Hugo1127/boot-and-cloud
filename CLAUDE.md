...
- **严禁**在代码中写"面试相关"注释（考点放 docs/interview-questions.md）
- 核心逻辑必须 **从零自研**
...
- 必须在 PROCESS.md 中登记状态

---

> **文档维护**：每次完成新功能或修复 Bug 后，同步更新本文档和 PROCESS.md。
> **PROCESS.md 规范**：已完成工作仅简要叙述（一两句话概括），重点放在**待解决问题**和**待修复项**，按优先级排列。
> **最后更新**：2026-05-26
